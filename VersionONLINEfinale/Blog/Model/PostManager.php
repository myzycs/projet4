...
class PostManager extends Manager
{
	public function getPosts()
	{
		...
		$req = $db->query('SELECT id, title, content,published, DATE_FORMAT(creation_date, \'%d/%m/%Y à %Hh%imin%ss\') AS date_creation_fr FROM posts WHERE published = 1 ORDER BY creation_date DESC LIMIT 0, 5');
